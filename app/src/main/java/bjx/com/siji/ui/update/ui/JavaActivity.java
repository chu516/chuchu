package bjx.com.siji.ui.update.ui;
...
import bjx.com.siji.ui.update.UpdateAppHttpUtil;
...
public class JavaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_java);
...
//                .showIgnoreVersion()
                ...
                .setTopPic(R.mipmap.icon_update_tip)
                //为按钮，进度条设置颜色。
