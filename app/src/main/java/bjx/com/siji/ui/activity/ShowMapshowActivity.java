...
import bjx.com.siji.overlayutil.BikingRouteOverlay;
import bjx.com.siji.overlayutil.DrivingRouteOverlay;
import bjx.com.siji.overlayutil.MassTransitRouteOverlay;
import bjx.com.siji.overlayutil.OverlayManager;
import bjx.com.siji.overlayutil.TransitRouteOverlay;
import bjx.com.siji.overlayutil.WalkingRouteOverlay;
...
public class ShowMapshowActivity  extends Activity implements BaiduMap.OnMapClickListener,
...
//    String endNodeStr = "百度科技园";
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(ShowMapshowActivity.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(ShowMapshowActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            // 起终点或途经点地址有岐义，通过以下接口获取建议查询信息
            // result.getSuggestAddrInfo()
            AlertDialog.Builder builder = new AlertDialog.Builder(ShowMapshowActivity.this);
            builder.setTitle("提示");
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShownDialogue) {
                    MyTransitDlg myTransitDlg = new MyTransitDlg(ShowMapshowActivity.this,
