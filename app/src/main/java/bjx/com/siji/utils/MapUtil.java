...
import static bjx.com.siji.utils.BitmapUtil.bmArrowPoint;
import static bjx.com.siji.utils.BitmapUtil.bmEnd;
import static bjx.com.siji.utils.BitmapUtil.bmStart;
...
public class MapUtil {
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > Util.getScreenHeight(App.getInstance()) - 500
                    || screenPoint.x < 200 || screenPoint.x > Util.getScreenWidth(App.getInstance()) - 200
                    || null == mapStatus) {
